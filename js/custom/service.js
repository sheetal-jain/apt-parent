...
function fnSlideWiseContentManage(slide){
    switch (slide) {
        ...
        case "capsule1_slide4":
            ...
            $('#rc-header-2').empty();
            $('#rc-header-2').append("<dfn>" + '"' + head + '"' + "</dfn>");
            $('#rc-header-que').text("What is the best way to respond?");
            $('#rc-content-select').removeClass('collapse');
            $('#rc-opt-1').text('"' + "I'm sure they won't bug you that much. Either way,you can just say no. And don't forgot to get your book back from Julie." + '"');
            $('#rc-opt-2').text('"' + "Julie doesm't mind having alchohol aria-atomic her parties? You're much too young! You shouldn't hang out with them if they bug you to drink." + '"');
            $('#rc-opt-3').text('"' + "You're worried about what your friends will say if they see you not drinking. Do you want to talk about it?" + '"');
            /* --- Wrong Answer --- */
            $('#lc-ans-img').attr('src', 'Images/6NStwRl6lCH_DX66_DY66_CX33_CY33.png');
            $('#lc-ans-header').text("that's not the best option.");
            $('#lc-ans-content').text("To be supportive, Jennifer should remain friendly and ask Michael if he wants to talk about it. Michael should feel that his mother is all ears and understands why he is worried.");
            /* --- Right Answer --- */
        ...
        case "capsule1_slide11":
            ...
            $('#rc-footer-confirm').removeClass('collapse');
            $('#rc-header-2').empty();
            $('#rc-header-2').append("<dfn>" + '"' + "Of course I'm angery! I don't understand why he acted that way..." + '"' + "</dfn>");
            $('#rc-opt-1').text('"' + "I am upset, I thought you had understood. Now I can't trust you anymore." + '"');
            $('#rc-opt-2').text('"' + "I am disappointed in your behaviour. We'll talk tommorrow at breakfast, when you've sobered up." + '"');
            $('#rc-opt-3').text('"' + "I knew it was a bad idea to let you go to a party where there would be alcohol. Why did you drink? Your friends really are bad influence on you!" + '"');
            $('#lc-ans-img').attr('src', 'Images/5tcf1kUdQOl_DX66_DY66_CX33_CY33.png');
            $('#lc-ans-header').text("that's right.");
            $('#lc-ans-content').text("Michael needs to feel that he can count on his mother, even if she is angry. She can express her concerns without judging him or criticizing him. In addition, it is not a good idea to talk while Michael is drunk. It is better to wail until he is sober.");
            /* --- Wrong Answer --- */
            //$('#lc-ans-img').attr('src', 'Images/6NStwRl6lCH_DX66_DY66_CX33_CY33.png');
            //$('#lc-ans-header').text("that's not the best option.");
            $('#l-c-footer-text').removeClass('collapse');
        ...
        case "capsule1_slide13":
            ...
            $('#rc-footer-confirm').removeClass('collapse');
            $('#rc-header-2').empty();
            $('#rc-header-2').append("<dfn>" + '"' + "I want him to know I am againstdrinking alcohol at this age, but also, but also want him to feel he can count on me when something is wrong." + '"' + "</dfn>");
            $('#rc-opt-1').text('"' + "Talk to me. I'd like to understand what happend." + '"');
            $('#rc-opt-2').text('"' + "There's no point in apologizing, I won't here any of it. I don't want you drinking alcohol anymore, that's it." + '"');
            $('#rc-opt-3').text('"' + "OK,it's your business. Do you want some orange juice" + '"');
            $('#lc-ans-img').attr('src', 'Images/5tcf1kUdQOl_DX66_DY66_CX33_CY33.png');
            $('#lc-ans-header').text("that's right.");
            $('#lc-ans-content').text("By calmly asking for explanations from her son, Jennifer will show that she is trying to understand his frustrations and is trying to help. Ignoring the situation or refusing to listen to Michael is not being supportive or affectionate, which compromises their meaningful relationship.");
            /* --- Wrong Answer --- */
            //$('#lc-ans-img').attr('src', 'Images/6NStwRl6lCH_DX66_DY66_CX33_CY33.png');
            //$('#lc-ans-header').text("that's not the best option.");
            $('#l-c-footer-text').removeClass('collapse');
        ...
        case "capsule2_slide1":
            ...
            $('.fw-content').append("<span class='font-xx-lg'>02</span>");
            ...
            $('#fw-header-1').text('COMMUNICATE EFECTIVELY with');
            $('#fw-header-1').css('margin-left', '-35px');
            $('#fw-header-2').text('YOUR ADOLESCENTS');
            $('#fw-footer-lr').removeClass('collapse');
            $('#fw-footer-img').addClass('collapse');
        ...
        case "capsule2_slide2":
            ...
            $('.r-c-header').addClass('collapse');
            $('#rc-content-select').addClass('collapse');
            $('#lc-header-1').text('COMMUNICATE EFECTIVELY with');
            $('#lc-header-1').css('margin-left', '-35px');
            $('#lc-header-2').text('YOUR ADOLESCENTS');
            $('#lc-content').append("<span class='font-xx-lg'>02</span>");
            break;
        ...
        case "capsule2_slide4":
            ...
            $('#rc-header-1').text('Dilema: ');
            $('#rc-header-2').empty();
            $('#rc-header-2').append("<dfn>" + '"' + "A wired guy?" + '"' + "</dfn>");
            $('#rc-header-que').text("What is the best way to respond?");
            $('#rc-opt-1').text('"' + "Just ignor him.So, Do you like your teachers ?" + '"');
            $('#rc-opt-2').text('"' + "Who is this guy? Why do you find him wired?" + '"');
            $('#rc-opt-3').text('"' + "Come on, we don't talk like that about other people! He must not be any different from the others in your class." + '"');
            $('#rc-footer-text').addClass('collapse');
            $('#rc-footer-confirm').removeClass('collapse');
            $('.convertion').addClass('collapse');
        ...
        case "capsule2_slide6":
            ...
            $('#rc-header-1').text('Dilema: ');
            $('#rc-header-2').empty();
            $('#rc-header-2').append("<dfn>" + '"' + "Speed….Should I talk to him about it ? I don't want to fuel his curiosity!" + '"' + "</dfn>");
            $('#rc-header-que').text("What is the best way to respond?");
            $('#rc-opt-1').text('"' + "It is very dangerous drug. I forbid you from talking it and I don't want to hear you talking about these things at home ." + '"');
            $('#rc-opt-2').text('"' + "I'm not sure I should tell you about it. I'm sure they'll explain it to you at school." + '"');
            $('#rc-opt-3').text('"' + "It's a drug. If you want, we can talk about it..." + '"');
            $('#rc-footer-text').addClass('collapse');
            $('#rc-footer-confirm').removeClass('collapse');
            $('.convertion').addClass('collapse');
            $('#conv2-slide3').addClass('collapse');
            $('#lc-ans-img').attr('src', 'Images/5tcf1kUdQOl_DX66_DY66_CX33_CY33.png');
            $('#lc-ans-header').text("that's right.");
            $('#lc-ans-content').text("Being open means answering honestly when an adolescent asks questions. Moreover, It has been proven that when parents talk to their children about drugs, they are less likely to use them. Jennifer and john should therefore pursue the discussion.");
            /* --- Wrong Answer --- */
            //$('#lc-ans-img').attr('src', 'Images/6NStwRl6lCH_DX66_DY66_CX33_CY33.png');
            //$('#lc-ans-header').text("that's not the best option.");
            $('#l-c-footer-text').removeClass('collapse');
        ...
        case "capsule2_slide12":
            ...
            $('#rc-content-text').removeClass('collapse');
            $('#rc-content-text').empty();
            $('#rc-content-text').append("<span class='font-med f-w-med block'>To communicate effectively with Michael, John and Jennifer must <span class='orange'>be open</span>. By doing so and asking questions about his circle of friends and what they do, they will be <span class='orange'>well informed</span>. They could also convey <span class='orange'>precautionary messages</span> about the use of psychoactive substances.</span>");
            $('#rc-footer-text').removeClass('collapse');
            $('#rc-footer-confirm').addClass('collapse');
            $('#rc-footer-span').empty();
        ...
        case "capsule3_slide1":
            ...
            $('.fw-content').removeClass('collapse');
            $('.fw-content').removeClass('cap1-last-slide');
            $('.fw-content').append("<span class='font-xx-lg'>03</span>");
            ...
            $('.fw-header').removeClass('collapse');
            $('.fw-footer').removeClass('collapse');
            $('#fw-header-1').text('Applying good');
            $('#fw-header-1').css('margin-left', '-16px');
            $('#fw-header-2').text('parenting practices');
            $('#fw-footer-lr').removeClass('collapse');
            $('#fw-footer-img').addClass('collapse');
            $('#fw-day').text('friday');
            $('#fw-time').text('6:00');
        ...
        case "capsule3_slide2":
            ...
            $('.r-c-header').addClass('collapse');
            $('#rc-content-select').addClass('collapse');
            $('#lc-header-1').text('Applying good');
            $('#lc-header-1').css('margin-left', '-16px');
            $('#lc-header-2').text('parenting practices');
        ...
        case "capsule3_slide3":
            ...
            $('#rc-header-1').text('Dilema: ');
            $('#rc-header-2').empty();
            $('#rc-header-2').append("<dfn>" + '"' + "It would make them happy to have their friends over, but of course we don't want things to get out of hand …" + '"' + "</dfn>");
            $('#rc-header-que').text("What is the best way to respond?");
            $('#rc-content-select').removeClass('collapse');
            $('#rc-opt-1').text('"' + "Ok, you can invite Matthew ans Sarah." + '"');
            $('#rc-opt-2').text('"' + "No problem,you can do whatever you like so long as everybody's gone when we get back!" + '"');
            $('#rc-opt-3').text('"' + "Absolutely not. There's no way we're going to allow a party to happen while we're not here." + '"');
            /* --- Right Answer --- */
            $('#lc-ans-img').attr('src', 'Images/5tcf1kUdQOl_DX66_DY66_CX33_CY33.png');
            $('#lc-ans-header').text("that's right.");
            $('#lc-ans-content').text("By allowing their teenagers to have friends over while they're out, Jennifer and John are demonstarting a heathy tolerance.");
            /* --- Wrong Answer --- */
            //$('#lc-ans-img').attr('src', 'Images/6NStwRl6lCH_DX66_DY66_CX33_CY33.png');
            //$('#lc-ans-header').text("that's not the best option.");
            /* --- Content --- */
        ...
        case "capsule3_slide5":
            ...
            $('#rc-header-1').text('Dilema: ');
            $('#rc-header-2').empty();
            $('#rc-header-2').append("<dfn>" + '"' + "We want them to live their lives, but we need to establish some ground rules first." + '"' + "</dfn>");
            $('#rc-header-que').text("What is the best way to respond?");
            $('#rc-opt-1').text('"' + "Go ahead,You're going to do what you want anyways." + '"');
            $('#rc-opt-2').text('"' + "No, you cannot have any alcohol.But it's true that we've never actually speoken about this. As we do for everything else, we're going to take the time to discuss this and establish some ground rules." + '"');
            $('#rc-opt-3').text('"' + "Out of the question.If you have any beer, you'll never be allowed to have any friends over again.Got it?" + '"');
            $('#rc-footer-text').addClass('collapse');
            $('#rc-footer-confirm').removeClass('collapse');
            $('.convertion').addClass('collapse');
        ...
        case "capsule3_slide10":
            ...
            $('#rc-header-1').text('Dilema: ');
            $('#rc-header-2').empty();
            $('#rc-header-2').append("<dfn>" + '"' + "I am angry but I have to stay clam so that I don't say anything I will regreat." + '"' + "</dfn>");
            $('#rc-header-que').text("What is the best way to respond?");
            $('#rc-opt-1').text('"' + "You understand that there will be consequences.No friends over for the next month." + '"');
            $('#rc-opt-2').text('"' + "You always do what you want! We'll never get anywere with you! Wait untill your father gets home…" + '"');
            $('#rc-opt-3').text('"' + "Ok,I am in no state to agure,so let's drop it.Don't tell your father and we'll forget it even happened." + '"');
            $('#rc-footer-text').addClass('collapse');
            $('#rc-footer-confirm').removeClass('collapse');
            $('.convertion').addClass('collapse');
            $('#conv3-slide4').addClass('collapse');
